...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionMy_profile = QAction(MainWindow)
        self.actionMy_profile.setObjectName(u"actionMy_profile")
        icon = QIcon(QIcon.fromTheme(QIcon.ThemeIcon.UserAvailable))
        self.actionMy_profile.setIcon(icon)
        ...
        self.menuKonto.addAction(self.actionMy_profile)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionMy_profile.setText(QCoreApplication.translate("MainWindow", u"My Profile", None))
#if QT_CONFIG(tooltip)
        self.actionMy_profile.setToolTip(QCoreApplication.translate("MainWindow", u"My Profile", None))
